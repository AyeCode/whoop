<div class="fullwidth-sidebar-container whoop-top-content">
	<div class="container">
		...
		<span class="whoop-archive-filters">
			<button class="whoop-show-filters " onclick="geodir_search_show_filters('.whoop-archive-filters .geodir-show-filters '); return false;"><i class="fas fa-sliders-h"></i> <?php _e("All Filters","whoop") ?></button>
			<?php
