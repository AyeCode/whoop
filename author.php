		...
		<div class="author-Profile-info">
			...
			<div class="gd-author-listing">
				<ul>
					...
					<li><p class="favorites-count"><?php echo $fav_list_count; ?></p><a href="<?php echo $user_link.'?gd_dashboard=true&style=favourite'; ?>"><i class="fa fa-bookmark"></i> Favourites</a></li>
